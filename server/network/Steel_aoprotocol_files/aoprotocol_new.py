...
# I'll use this file as a way of testing out my edits and breaking stuff out into the below files:
# aoprotocol_iccmd_handling
# aoprotocol_ooccmd_handling
# aoprotocol_validator
...
from network import aoprotocol_iccmd_handling
from network import aoprotocol_ooccmd_handling
from network import aoprotocol_validator
...
class AOProtocol(asyncio.Protocol):
	...
	def net_cmd_ms(self, args):
		...
		# First step, clean up validation. Parameters being passed:
		# self, args
		# Function to use:
		# net_validate(self, args)
		# How to handle it... what we need is particular data being passed back by net_validate. It should come as an integer, since we have the original args
		# package provided in the parent function.
		# Really, all net_validate should do is provide a version number.

		version = net_validate(self, args)
